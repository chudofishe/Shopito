...
//                    categoriesAdapter.removeAll()
        ...
        menuHost.addMenuProvider(object : MenuProvider {
            ...
            override fun onMenuItemSelected(menuItem: MenuItem): Boolean {
                when(menuItem.itemId) {
                    R.id.action_clear_list -> categoriesAdapter.removeAll()
                    R.id.action_mark_list_as_done -> categoriesAdapter.completeList()
        ...
        submitButton.setOnClickListener {
            if (!itemName.text.isNullOrEmpty()) {
                ...
                categoriesAdapter.addItem(ShoppingItem(
...
//                    hideKeyboard(itemInput)
    ...
    override fun onDestroyView() {
        ...
        val title = titleInput.editText?.text.toStringOrNull()
        viewModel.saveTempState(title, categoriesAdapter.getShoppingItems())
    }
